...
面板端(稳定版)：
```bash
curl -L https://raw.githubusercontent.com/lukelane789/flux-panel-v1.4.3/main/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
节点端(稳定版)：
```bash
curl -L https://raw.githubusercontent.com/lukelane789/flux-panel-v1.4.3/main/install.sh -o install.sh && chmod +x install.sh && ./install.sh
